      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Update live pricing, color shades, and cut/silhouette options for <span className="text-amber-400 font-semibold">{initialProduct.name}</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            target="_blank"
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-xs font-bold text-slate-300 transition"
          >
          ...
          <button
            type="submit"
            disabled={isSaving}
            className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-bold transition shadow disabled:opacity-50 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
            <h2 className="text-xs font-black uppercase tracking-wider text-amber-500 flex items-center gap-2 border-b border-slate-800 pb-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs p-3 rounded-xl bg-slate-950 border border-slate-800 text-white font-mono focus:border-amber-500 outline-hidden"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs p-3 rounded-xl bg-slate-950 border border-slate-800 text-amber-400 font-mono font-bold focus:border-amber-500 outline-hidden"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 border-t border-slate-800/80">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs p-3 rounded-xl bg-slate-950 border border-slate-800 text-slate-300 font-mono focus:border-amber-500 outline-hidden"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800">
                ...
                <input
                  ...
                  className="w-full text-xs p-2.5 rounded-lg bg-slate-900 border border-slate-800 text-amber-400 font-mono font-bold"
                />
          ...
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-400 mb-1">Full Title</label>
              <input
                type="text"
                required
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full text-xs p-3 rounded-xl bg-slate-950 border border-slate-800 text-white focus:border-amber-500 outline-hidden font-bold"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="w-full text-xs p-3 rounded-xl bg-slate-950 border border-slate-800 text-slate-300 focus:border-amber-500 outline-hidden"
              />
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
            <h2 className="text-xs font-black uppercase tracking-wider text-amber-500 pb-2 border-b border-slate-800">
            ...
            <div className="text-xs space-y-1">
              <div className="flex justify-between text-slate-400">
                <span>Category:</span>
                <strong className="text-white">{initialProduct.category?.name || 'Couture'}</strong>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>Brand:</span>
                <strong className="text-white">{initialProduct.brand?.name || 'MFE'}</strong>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-3">
            ...
            <label className="flex items-center gap-2 p-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs cursor-pointer">
              <input
                type="checkbox"
                checked={isFeatured}
              ...
              />
              <span>Featured Haute Piece</span>
            </label>
            ...
            <label className="flex items-center gap-2 p-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs cursor-pointer">
              <input
                ...
                className="rounded text-amber-500"
              />
              <span>Special Atelier Deal</span>
            </label>
