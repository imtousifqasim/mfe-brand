    ...
    <div className="space-y-6 font-sans pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="p-2.5 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-slate-600 hover:text-slate-900 transition shadow-2xs cursor-pointer self-start sm:self-auto"
      ...
      <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition cursor-pointer ${
            filter === 'all' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200 shadow-2xs'
          }`}
        >
          All ({reviews.length})
        </button>
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer ${
            filter === 'pending' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200 shadow-2xs'
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition cursor-pointer ${
            filter === 'approved' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200 shadow-2xs'
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-bold transition cursor-pointer ${
            filter === 'rejected' ? 'bg-slate-900 text-white shadow-xs' : 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200 shadow-2xs'
          }`}
        >
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="p-12 text-center bg-white border border-slate-200/90 rounded-2xl text-xs text-slate-500 shadow-xs">
          ...
          filteredReviews.map((r) => (
            <div
              key={r.id}
              className="p-6 rounded-2xl bg-white border border-slate-200/90 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs"
            >
              <div className="space-y-2 max-w-2xl">
                ...
                <div className="flex items-center gap-1 text-amber-500">
                  ...
                  <span className="font-bold text-xs text-slate-900 ml-2">{r.title}</span>
                </div>
                ...
                {r.product_name && (
                  <p className="text-[11px] text-slate-500 pt-1">
                    <span className="text-slate-400">Product:</span> <strong className="text-slate-800">{r.product_name}</strong>
                  </p>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                {r.status !== 'approved' && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-700 text-xs font-bold transition shadow-2xs cursor-pointer"
                  >
                ...
                {r.status !== 'rejected' && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 text-xs font-bold transition shadow-2xs cursor-pointer"
                  >
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-white hover:bg-rose-50 text-slate-400 hover:text-rose-600 border border-slate-200 transition shadow-2xs cursor-pointer"
                  title="Delete Review"
                >
